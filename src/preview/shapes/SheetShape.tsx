 ...
 */
export function SheetShape({ title, description, fill = false }: Props) {
  const { t } = useTranslation('shapes');
  const resolvedTitle = title ?? t('sheet.title');
  const resolvedDescription = description ?? t('sheet.description');
